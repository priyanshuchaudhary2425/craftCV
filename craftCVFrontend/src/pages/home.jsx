...
function Home({ result, setResult }) {
  ...
  const handleFileChange = (e) => {
    ...
    // Always wrap it as a clean PDF file
    const safeFile = new File([selected], "resume.pdf", { type: "application/pdf" });
    setFile(safeFile);
  };
  ...
  return (
    <div className={styles.mainContainer}>
      <div className={styles.banner}>
        ...
        <p>
          “Not sure if your resume is good enough? We show you exactly what works,
          what doesn’t, and help you fix it — fast.”
        </p>
      </div>
